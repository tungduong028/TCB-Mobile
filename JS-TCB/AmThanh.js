...
const btnCoday = document.querySelector('.btnCoday');
const btnBluetooth = document.querySelector('.btnBluetooth');
const btnLoa = document.querySelector('.btnLoa');
...
//Phân loại tai nghe có dây
const coday = products.filter((item, index) => {
    return item.subcategory == 'tainghecoday'
})
btnCoday.addEventListener('click', () => {
    renderProduct(coday);
})

//Phân loại tai nghe Bluetooth
const bluetooth = products.filter((item, index) => {
    return item.subcategory == 'tainghebluetooth'
})
btnBluetooth.addEventListener('click', () => {
    renderProduct(bluetooth);
})

//Phân loại loa
const loa = products.filter((item, index) => {
    return item.subcategory == 'loa'
})
btnLoa.addEventListener('click', () => {
    renderProduct(loa);
})
