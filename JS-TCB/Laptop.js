...
const btnMacbook = document.querySelector('.btnMacbook');
const btnAsus = document.querySelector('.btnAsus');
...
//Phân loại Macbook
const macbook = products.filter((item, index) => {
    return item.subcategory == 'macbook'
})
btnMacbook.addEventListener('click', () => {
    renderProduct(macbook);
})

//Phân loại laptop Asus
const asus = products.filter((item, index) => {
    return item.subcategory == 'asus'
})
btnAsus.addEventListener('click', () => {
    renderProduct(asus);
})

//Phân loại laptop Acer
const acer = products.filter((item, index) => {
    return item.subcategory == 'acer'
})
btnAcer.addEventListener('click', () => {
    renderProduct(acer);
})
